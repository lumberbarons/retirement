...
Expansions of the finance, budget, and retirement acronyms used in the specs.
Not all of these are in scope for the first epic; some appear only as
out-of-scope notes or as sources the engine relies on.
